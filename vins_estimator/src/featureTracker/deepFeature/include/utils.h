...
#  if __has_include(<g2o/types/slam3d/types_slam3d.h>) && __has_include(<g2o/types/slam3d_addons/types_slam3d_addons.h>)
#    include <g2o/types/slam3d/types_slam3d.h>
#    include <g2o/types/slam3d_addons/types_slam3d_addons.h>
#    define DEEPFEATURE_HAS_G2O 1
#  else
#    define DEEPFEATURE_HAS_G2O 0
#  endif
#else
#  define DEEPFEATURE_HAS_G2O 0
#endif

#if DEEPFEATURE_HAS_G2O
typedef std::shared_ptr<g2o::Line3D> Line3DPtr;
typedef std::shared_ptr<const g2o::Line3D> ConstLine3DPtr;
#else
struct Line3D;
typedef std::shared_ptr<Line3D> Line3DPtr;
typedef std::shared_ptr<const Line3D> ConstLine3DPtr;
#endif
